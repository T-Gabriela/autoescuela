...
if (isset($_GET['id'])) {
    $stmt = $pdo->prepare("SELECT * FROM clientes WHERE id = ? AND borrado = FALSE");
...
<html>
<head>
    <title><?php echo $cliente['id'] ? 'Editar' : 'Nuevo'; ?> Cliente</title>
    <style>
...
<body>
    <h1><?php echo $cliente['id'] ? 'Editar Cliente' : 'Nuevo Cliente'; ?></h1>
